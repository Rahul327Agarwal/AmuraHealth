...
export const useStyles = makeStyles<IProps | any>()(
  (theme, { isEmergency, isBgWhite, isBorderRadius, handleSelect, ...props }) => ({
    mainContainer: {
      display: 'flex',
      backgroundColor: isBgWhite || isEmergency ? '#FFF' : '#F1F1F1',
      padding: '12px 20px',
      ...
      '&::before': {
        ...
        left: 0,
        width: '6px',
        backgroundColor: isEmergency ? '#FF3B30' : 'transparent',
      },
    },
    ...
    postIconSmall: {
      ...
      padding: '4px 8px',
      borderRadius: '50%',
      backgroundColor: isBgWhite || isEmergency ? '#F1F1F1' : '#FFF',
      '& svg': {
        width: '16px',
      },
    },
