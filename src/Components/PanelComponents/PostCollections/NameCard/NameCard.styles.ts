...
export const useStyles = makeStyles<IProps | any>()((theme, props) => ({
  mainContainer: {
    display: 'flex',
    backgroundColor: props.isClientSelected ? theme.palette.colors.system.white : theme.palette.colors.gray[50],
  ...
  subContainer4: {
    display: 'grid',
    gridTemplateColumns: `${props.isExtend ? '116px' : 'auto 116px'}`,
    marginBottom: '8px',
  },
  ...
  captionCon: {
    padding: '4px 8px',
    backgroundColor:
      props?.isBgWhite || props?.isEmergency || props?.isClientSelected
    ...
    marginLeft: props.isExtend ? 'left' : 'auto',
  },
  textColor: {
    color: theme.palette.colors.gray[400],
    textOverflow: 'ellipsis',
