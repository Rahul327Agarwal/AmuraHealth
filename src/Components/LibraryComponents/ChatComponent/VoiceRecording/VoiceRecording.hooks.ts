...
import { startRecording, saveRecording, pauseRecording, resumeRecorder } from "./VoiceRecording.functions";
...
export default function useRecorder() {
  ...
  return {
    ...
    resumeRecording: () => resumeRecorder(recorderState.mediaRecorder)
  };
}
