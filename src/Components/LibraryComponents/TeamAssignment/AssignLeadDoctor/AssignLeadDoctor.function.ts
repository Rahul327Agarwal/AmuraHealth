...
import { ISelectedClient, ITransferData } from '../CareTeam.types';
...
export const getAllStaffProfileFromRole = async (panelId: string, props: any) => {
...
export const onSave = async (
  ...
  if (staffHasMultiRole) {
    ...
    if (index > -1) {
      ...
      ErrorToaster('This staff has the selected role is already.', panelId, 'error');
