export const amura_consulting_physician = {
  Allergies: {
    Allergies: 'Viewable',
  ...
  Diagnosis: {
    Diagnosis: 'Clickable',
    'Diagnosis.1': 'Clickable',
    'Diagnosis.2': 'Clickable',
    'Diagnosis.3': 'Clickable',
    'Diagnosis.2A': 'Clickable',
    'Diagnosis.2B': 'Clickable',
    'Diagnosis.3A': 'Clickable',
    'Diagnosis.3B': 'Clickable',
    'Diagnosis.1C': 'Clickable',
    'Diagnosis.1D': 'Clickable',
    'Diagnosis.1E': 'Clickable',
  },
  FoodSensitivities: {
  ...
  PrescriptionGenerate: {
    ...
    'PrescriptionGenerate.6C': 'Clickable',
  },
  PrescriptionHistory: {
