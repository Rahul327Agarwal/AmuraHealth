export const BasicUser = {
  ...
  PrescriptionGenerate: {
    PrescriptionGenerate: 'Clickable',
    'PrescriptionGenerate.1': 'Clickable',
    'PrescriptionGenerate.2': 'Clickable',
    'PrescriptionGenerate.3': 'Clickable',
    'PrescriptionGenerate.4': 'Clickable',
    'PrescriptionGenerate.5': 'Clickable',
    'PrescriptionGenerate.6': 'Clickable',
    'PrescriptionGenerate.6C': 'Disabled',
  },
  PrescriptionHistory: {
  ...
  PatientBasicProfileDetails: {
    ...
    'PatientBasicProfileDetails.10': 'Viewable', //PreferredLanguages
    'PatientBasicProfileDetails.10A': 'Viewable', //language_preference
    'PatientBasicProfileDetails.11': 'Viewable', //Mobile
    'PatientBasicProfileDetails.12': 'Viewable', //whatsAppNumber
    'PatientBasicProfileDetails.13': 'Viewable', //ResidingCountry
    'PatientBasicProfileDetails.14': 'Viewable', //Nationality
    'PatientBasicProfileDetails.15': 'Viewable', //location
    'PatientBasicProfileDetails.16': 'Viewable', //City
    ...
    'PatientBasicProfileDetails.19': 'Viewable', //emergencyContact
    'PatientBasicProfileDetails.20': 'Viewable', //USDatabase
    'PatientBasicProfileDetails.21': 'Viewable', //SocialPlatforms
...
export const L2TreatingDoctor = {
  ...
  PatientBasicProfileDetails: {
    PatientBasicProfileDetails: 'Viewable',
    'PatientBasicProfileDetails.1': 'Viewable', //height 1 2 3
    'PatientBasicProfileDetails.2': 'Viewable', //weight 1 2 3
    'PatientBasicProfileDetails.3': 'Viewable', //DateOfBirth 1 3
    'PatientBasicProfileDetails.3A': 'Viewable', //date_of_birth 2
    'PatientBasicProfileDetails.4': 'Viewable', //Gender 3
    'PatientBasicProfileDetails.4A': 'Viewable', //genderData 1
    'PatientBasicProfileDetails.4B': 'Viewable', //userTypedGender 2
    'PatientBasicProfileDetails.4C': 'Viewable', //MedicallyModifiedGender 2
    'PatientBasicProfileDetails.5': 'Viewable', //HealthType 1
    'PatientBasicProfileDetails.6': 'Viewable', //ConditionsInterested 2
    'PatientBasicProfileDetails.7': 'Viewable', //FoodRestriction 2 3
    'PatientBasicProfileDetails.8': 'Viewable', //DietPreference 1
    'PatientBasicProfileDetails.9': 'Viewable', //Cuisine 1 3
    'PatientBasicProfileDetails.9A': 'Viewable', //cuisine 2
    'PatientBasicProfileDetails.10': 'Disabled', //PreferredLanguages
    'PatientBasicProfileDetails.10A': 'Disabled', //language_preference
    'PatientBasicProfileDetails.11': 'Viewable', //Mobile 1 3
    ...
    'PatientBasicProfileDetails.17': 'Viewable', //EMail 1 3
    'PatientBasicProfileDetails.17A': 'Viewable', //email 2
    'PatientBasicProfileDetails.18': 'Viewable', //bloodGrp 1 2 3
    ...
    'PatientBasicProfileDetails.22': 'Viewable', //sex 2
  },
  PrescriptionHistory2C: { PrescriptionHistory2C: 'Disabled' },
  InvestigationReports: { 'InvestigationReports.1': 'Viewable' },
  RMPanel: {
