const CHECK_INTERVAL_TIME = 1000 * 10;
let CHECK_INTERVAL: string | number | NodeJS.Timeout | null | undefined = null;
...
export function register(config?: Config) {
  if ('serviceWorker' in navigator) {
    ...
    try {
      ...
      console.error('Error while loading SW', e);
    }
        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === 'installed') {
            if (navigator.serviceWorker.controller) {
              ...
              console.log(
                'New content is available and will be used when all1223 ' +
